...
def load_transport_data(): 
    parkeringsautomater_gdf = gpd.read_file(file_path() + "/data/transport/parkeringsautomater.gpkg")#CRS: EPSG:3006    
...
if address_search:
    ...
    selected_distance = int(st.sidebar.number_input(f'Distance to selected address? KM ', min_value=0.0, max_value=15.0, value=6.0, step=0.5, key='distance'))
